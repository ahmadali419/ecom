                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">Customer Order List</h3>
                        </div>

                    </div>
                    <input type="hidden" name="user_email" id="user_email" value="{{$email_user}}">
                    <div class="card-body">
                        <!--begin: Search Form-->
                            ...
                            <div class="row mb-6">
                                <div class="col-lg-3 mb-lg-3 mb-2">
                                    <div class="form-group">
                                        ...
                                        <div class="w-100">
                                            <select class="form-control select2 kt-select2-general categories  datatable-input" id="store_id"  data-col-index="1" >
                                ...
                                <div class="col-lg-3 mb-lg-3 mb-2">
                                    <label>Order:</label>
                                    <input type="text" class="form-control datatable-input" placeholder="E.g: test" data-col-index="0" />
                                </div>
            ...
            $(document).on('click','.delete',function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: "{{route('orderDelete')}}", // your php file name
                            data: form_data,
                            dataType: "json",
                            processData: false,
                            contentType: false,
        ...
        function updateStatus(id,status)
        {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "POST",
                        url: "{{route('orderUpdate')}}", // your php file name
                        data: form_data,
                        dataType: "json",
                        processData: false,
                        contentType: false,
