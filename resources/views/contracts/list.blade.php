                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">Contracts List</h3>
                        </div>
                        <div class="card-toolbar">
                            ...
                            <!--end::Dropdown-->
                            <!--begin::Button-->
                            <a href="{{route('createContract')}}" class="btn btn-primary font-weight-bolder">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter contract name" />
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" name="date_range" id="date_range" readonly="readonly" placeholder="Select Date" type="text">
                            </div>
                            {{-- <div class="col-md-6">
                                <label class="col-form-label">End Date<span class="text-danger">*</span></label>

                                <div class="input-group date mb-2">
                                    <input type="text" class="form-control" placeholder="Contract End" name="contract_end" id="contract_end" />
                ...
                table = $('#datatableList').DataTable({
                    ...
                    ajax: {
                        ...
                        data: {
                            ...
                            columnsDef: [
                                'id', 'Name', 'Amount' ,'Duration','created_at'
                            ],
                    ...
                    columns: [
                        {data: 'id'},
                        {data: 'Name'},
                        {data: 'Duration', responsivePriority: -1, bSortable: false},
                        {data: 'created_at'},
