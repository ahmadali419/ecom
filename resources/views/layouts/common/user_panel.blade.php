    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                <a href="{{ route('userProfile') }}" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{ucfirst(Auth::user()->name)}}</a>
                <div class="text-muted mt-1">{{ucfirst(Auth::user()->type)}}</div>
                <div class="navi mt-2">
