                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">Charges List</h3>
                        </div>
            ...
            <form method="post" id="addForm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <h5 class="text-dark">Charge Info</h5>
                            </div>
                            <div class="col-md-12">
        ...
        jQuery(document).ready(function() {
            ...
            $(document).on('click', '#btn_save', function(){
                ...
                if(validate) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{route('chargeSubmit')}}", // your php file name
                        data: form_data,
                        dataType: "json",
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            $(document).on('click','.edit',function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('getChargeById')}}", // your php file name
                    data: form_data,
                    dataType: "json",
                    processData: false,
                    contentType: false,
            ...
            $(document).on('click','.delete',function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: "{{route('chargeDelete')}}", // your php file name
                            data: form_data,
                            dataType: "json",
                            processData: false,
                            contentType: false,
