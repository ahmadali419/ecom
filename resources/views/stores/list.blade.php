                        ...
                        <form class="kt-form kt-form--fit">
                            <div class="row mb-6">
                                <div class="col-lg-3 mb-lg-0 mb-2">
                                    <label>Name:</label>
                                    <input type="text" class="form-control datatable-input" placeholder="E.g: store name" data-col-index="1" />
                                </div>
                                <div class="col-lg-3 mb-lg-0 mb-2">
                                    <label>Contract:</label>
                                        <select class="form-control selectpicker datatable-input" data-col-index="2" data-live-search="true">
                                    ...
                                    {{--<input type="text" class="form-control datatable-input" placeholder="E.g: contract name" data-col-index="2" />--}}
                                </div>
                                <div class="col-lg-3 mb-lg-0 mb-2">
                                    <label>&nbsp;</label><br />
            ...
            <form onsubmit="return false" id="addForm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <h5 class="text-dark">Store Info</h5>
                            </div>
                            <div class="col-md-6">
                                <label class="col-form-label">Store Name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)"  name="name" id="name" placeholder="Enter store name" />
                            </div>
                            <div class="col-md-6">
                ...
                table = $('#datatableList').DataTable({
                    ...
                    ajax: {
                        ...
                        data: {
                            ...
                            columnsDef: [
                                'id', 'Name', 'contract_name' ,'Address','created_at'
                            ],
        ...
        jQuery(document).ready(function() {
            ...
            $(document).on('click', '#btn_save', function(){
                ...
                if(validate) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{route('storeSubmit')}}", // your php file name
                        data: form_data,
                        dataType: "json",
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            $(document).on('click','.edit',function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('getStoreById')}}", // your php file name
                    data: form_data,
                    dataType: "json",
                    processData: false,
                    contentType: false,
            ...
            $(document).on('click','.delete',function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: "{{route('storeDelete')}}", // your php file name
                            data: form_data,
                            dataType: "json",
                            processData: false,
                            contentType: false,
