            ...
            <form onsubmit="return false" id="addForm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <h5 class="text-dark">Category Info</h5>
                            </div>
                            <div class="col-md-4">
                                <label class="col-form-label">Category Name *</label>
                                <input type="text" class="form-control" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)"  name="name" id="name" placeholder="Enter category name" />
                            </div>
                            <div class="col-md-4">
                                <label class="col-form-label">Profile Photo</label>
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" class="upload-image-site w-100" id="image1" name="category_logo"  /><br/>
                                        <div id="frames1"></div>
                ...
                $.ajax({
                    ...
                    success: function (data){
                        if(data.status == 'success') {
                            ...
                            $('#id').val(id);
                            $('#name').val(name);
                            $('#old_image').val(rec.image);
                            $('#frames1').html('<img src="'+data.image_path+'" style="margin-top:20px; text-align:center" width="50px" height="50px"/>');
        ...
        $(document).ready(function(){
            $('#image1').change(function(){
                ...
                for (var i = 0; i < $(this)[0].files.length; i++) {
                    $("#frames1").append('<img src="'+window.URL.createObjectURL(this.files[i])+'" style="margin-top:20px; text-align:center" width="50px" height="50px"/>');
                }
            });
        });
    </script>
