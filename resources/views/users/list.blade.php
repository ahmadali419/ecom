                ...
                <div class="modal-body">
                    <div class="row mb-2">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="name" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)"  id="name" placeholder="Enter name" />
                        </div>
                        <div class="col-md-3">
...
jQuery(document).ready(function() {
    ...
    $(document).on('click', '#btn_add_new', function() {
        ...
        $("#frames1").empty();
        $("#phone_number").intlTelInput("setCountry", "");
        resetForm();
    });
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.status == 'success') {
                    ...
                    var country_short_name = rec.country_short_name;
                    ...
                    if(!country_short_name){
                         ...
                         $("#phone_number").intlTelInput("setCountry", country_short_name);
                    }
    ...
    function resetForm() {
        ...
        $(this).val();
          ...
          //  console.log("countryName > " + initialCountry);
