                        ...
                        <form class="kt-form kt-form--fit">
                            <div class="row mb-6">
                                <div class="col-lg-3 mb-lg-0 mb-2">
                                    <label>Name:</label>
                                    <input type="text" class="form-control datatable-input" placeholder="E.g: name" data-col-index="1" />
                                </div>
                                <div class="col-lg-3 mb-lg-0 mb-2">
                                    <label>&nbsp;</label><br />
            ...
            <form onsubmit="return false" id="addForm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <h5 class="text-dark">Color Info</h5>
                            </div>
                            <div class="col-md-12">
                                <label class="col-form-label">Color Name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)"  name="name" id="name" placeholder="Enter Color Name" />
                            </div>
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function() {
            ...
            $(document).on('click','.edit',function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('getColorById')}}", // your php file name
                    data: form_data,
                    dataType: "json",
                    processData: false,
                    contentType: false,
            ...
            $(document).on('click','.delete',function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: "{{route('colorDelete')}}", // your php file name
                            data: form_data,
                            dataType: "json",
                            processData: false,
                            contentType: false,
